...
Última actualización: **2026-08-09** (cierre de F-H)
...
```
Continuamos el rework. Leé docs/REWORK-ESTADO.md y después docs/fases/F-I.md.
...
| **1** | **F-I** | [Afinado de prompts](fases/F-I.md) | ☐ **← ACÁ ESTAMOS** — que el modelo aproveche todo lo que se le pasa y **sepa lo que le falta**. El manifiesto de F-H ya dice qué se recortó; falta que el informe lo declare |
| **2** | **F-B1** | [Store: esquema y capa de acceso](fases/F-B1.md) | ☐ El DDL, las migraciones y `models.py`. No toca nada que esté corriendo |
| **3** | **F-B2** | [Ingesta idempotente y backfill](fases/F-B2.md) | ☐ El colector empieza a escribir; backfill de lo que ya hay en disco |
| **4** | **F-E** | [Listas locales](fases/F-E.md) | ☐ **Adelantada**: el filtro gratis tiene que estar antes de gastar cuota |
| **5** | **F-C** | [Enricher inverso y triage](fases/F-C.md) | ☐ La pieza central — responde la pregunta de estudio |
| **6** | **F-D** | [Reincidencia](fases/F-D.md) | ☐ Convierte el dato en conocimiento. Cierre real bloqueado por tráfico SSH |
...
- **F-I sigue a F-H** porque el manifiesto de la corrida es también material de prompt: la mejora
  más grande es que el modelo **sepa lo que no tiene**. Los `drops` ya están medidos; falta que
  entren al prompt y que el informe los declare.
